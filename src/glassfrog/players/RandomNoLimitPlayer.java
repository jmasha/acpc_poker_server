...
public class RandomNoLimitPlayer extends RandomPlayer{        
     ...
     */
    public RandomNoLimitPlayer(String name, int buyIn, int seat, int seed) {
        super(name,buyIn,seat,seed);
    }
     ...
     */
    public RandomNoLimitPlayer(String name, int buyIn, int seat, String weights) {
        super(name,buyIn,seat, weights);
    }
     ...
     * @param seat int representing the player's seat
     */
    public RandomNoLimitPlayer(String name, int buyIn, int seat) {
